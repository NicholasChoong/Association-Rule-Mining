...
IF EXISTS (SELECT [name] FROM [master].[sys].[databases] WHERE [name] = N'JobPostsDW_ARM')
DROP DATABASE JobPostsDW_ARM;
GO

PRINT '';
PRINT '*** Creating Database_ARM';
GO

Create database JobPostsDW_ARM
Go
